...
if __name__ == "__main__":
    args = parse_args()
    cfg = TrainConfig(
        method="train_pure_sigreg_RandomHardQR",
        seed=args.seed,
        device=args.device,
        epochs=args.epochs,
        ...
        logdir=(args.logdir or f"runs/train_pure_sigreg_RandomHardQR_seed{args.seed}"),
        ckpt_path=(args.ckpt or f"checkpoints/train_pure_sigreg_RandomHardQR_seed{args.seed}.pt"),
    )
    train(cfg)
