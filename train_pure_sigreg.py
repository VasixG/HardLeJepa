        ...
        if epoch % cfg.eval_every_epochs == 0:
            ...
            if epoch % cfg.report_every_epochs == 0:
                save_pca_scatter(
                    ...
                    title=f"pure_sigreg | epoch {epoch} | PCA (test)",
                ...
                save_tsne_scatter(
                    ...
                    title=f"pure_sigreg | epoch {epoch} | t-SNE (test)",
                ...
                save_confusion_matrix(
                    ...
                    title=f"pure_sigreg | epoch {epoch} | kNN confusion",
                    normalize=True,
                )
                ...
                if epoch % cfg.retrieval_every_epochs == 0:
                    save_retrieval_collage(
                        ...
                        title=f"pure_sigreg | epoch {epoch} | retrieval (test->train)",
