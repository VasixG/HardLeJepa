...
if __name__ == "__main__":
    args = parse_args()
    cfg = TrainConfig(
        method="train_pure_sigreg_HardMaxQR",
        seed=args.seed,
        device=args.device,
        epochs=args.epochs,
        ...
        logdir=(args.logdir or f"runs/train_pure_sigreg_HardMaxQR_seed{args.seed}"),
        ckpt_path=(args.ckpt or f"checkpoints/train_pure_sigreg_HardMaxQR_seed{args.seed}.pt"),
    )
    train(cfg)
